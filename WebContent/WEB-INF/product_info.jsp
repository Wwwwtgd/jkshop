	...
	<div class="container">
		<div class="row">
			<div
				...
				<a href="${pageContext.request.contextPath }/product?method=productListByCid&cid=${product.cid}&currentPage=${currentPage}">返回商品列表
			...
			<div style="width: 950px; margin: 0 auto;">
				...
				<div>
					<img  style=" width: 930px;"
						src="${pageContext.request.contextPath }/${product.bigimage}">
				</div>
