...
<html>
					...
					<table class="table table-bordered">
						<tbody>
							...
							<tr class="active">
								...
								<td>
									<a href="javascript:void(0);" onclick="delFromCart('${cartItem.value.product.pid}')" class="delete">删除</a>
								</td>
							</tr>
							</c:forEach>
						</tbody>
	...
	<script type="text/javascript">
		...
		function submitOrder(){
			window.location = '${pageContext.request.contextPath}/product?method=submitOrder';
		}
	</script>
	</body>
