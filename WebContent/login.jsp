...
<body>
				...
				<div
					...
					<form class="form-horizontal" action="${pageContext.request.contextPath}/user" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" id="checknumber" name="checknumber" placeholder="请输入验证码">
							</div>
							<div class="col-sm-4">
								<img  id="checkCodeImage" src=""  onclick="getCheckCode()" title="点击换一张"/>
							</div>
						</div>
						<div class="form-group">
							...
							<label style="color:red;" class="col-sm-4 control-label">${loginError}</label>
						</div>
						<div class="form-group">
	...
	<script type="text/javascript">
		function getCheckCode(){
			...
			img.src='checkCodeImage?method=getCheckCode&a=' + date.getTime();
		}
		getCheckCode()
	</script>
</body>
